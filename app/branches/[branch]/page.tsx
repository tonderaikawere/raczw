...
const branchesData: Record<string, any> = {
  mbundane: {
    ...
    description:
      "Our Mbundane Branch is a vibrant community dedicated to raising the next generation of believers through focused youth discipleship programs and family-centered ministry.",
    history:
      "Established in 2019 as our second branch, Mbundane has grown from 25 members to a thriving family of 180 believers, becoming a beacon of hope in the community.",
    achievements: [
  ...
  "city-center": {
    ...
    location:
      "Corner of Leopold Takawira Avenue and Fife Street, Bulawayo CBD (Drill Hall)",
    pastor: "Pastor Chiwire & Amai",
    leadership: [
      { role: "Pastor", name: "Pastor Chiwire", spouse: "Amai" },
      { role: "Mvangeri", name: "Mvangeri Chigume", spouse: "Amai" },
      { role: "Secretary", name: "Secretary Muchakata", spouse: "Amai" },
    ],
    members: 210,
    ...
    description:
      "Located in the heart of Bulawayo, our City Centre Branch is strategically positioned for urban ministry and marketplace evangelism, reaching professionals and city dwellers.",
    history:
      "Founded in 2018 as our flagship branch, City Centre has become the spiritual hub for urban ministry, reaching the business community and city residents with the gospel.",
    achievements: [
  ...
  "cowdry-park-a": {
    name: "Cowdray Park A Branch",
    location: "Cowdray Park, Bulawayo",
    pastor: "Pastor Mavuto & Amai",
    leadership: [{ role: "Pastor", name: "Pastor Mavuto", spouse: "Amai" }],
    members: 145,
    ...
    contact: {
      ...
      address: "127 Cowdray Park, Bulawayo",
      coordinates: "-20.1500, 28.5830",
    },
    description:
      "Our Cowdray Park A Branch is a family-focused community dedicated to restoring families through biblical principles and strong fellowship.",
    history:
      "Established in 2020 to serve the growing Cowdray Park community, this branch has become known for its strong family ministry and community outreach programs.",
    achievements: [
    ...
    upcomingEvents: [
      {
        title: "Family Restoration Seminar",
        date: "2025-02-12",
        time: "2:00 PM",
      },
  ...
  "cowdry-park-b": {
    name: "Cowdray Park B Branch",
    location: "Cowdray Park, Bulawayo",
    pastor: "Pastor Chivheya & Amai",
    leadership: [{ role: "Pastor", name: "Pastor Chivheya", spouse: "Amai" }],
    members: 135,
    ...
    contact: {
      ...
      address: "324 Cowdray Park, Bulawayo",
      coordinates: "-20.1500, 28.5830",
    },
    description:
      "Cowdray Park B Branch is known for its powerful deliverance ministry and spiritual warfare, bringing freedom to many through prayer.",
    history:
      "Founded in 2021 with a special focus on deliverance ministry, this branch has become a place of freedom and restoration for many seeking spiritual breakthrough.",
    achievements: [
  ...
  phumula: {
    ...
    leadership: [
      { role: "Pastor", name: "Pastor Mugwagwa", spouse: "Amai" },
      { role: "Mvangeri", name: "Mvangeri Madzikatire", spouse: "Amai" },
      { role: "Secretary", name: "Secretary Mphande" },
    ],
    members: 125,
    ...
    contact: {
      ...
      address: "Pumula, Bulawayo",
      coordinates: "-20.1500, 28.5830",
    },
    description:
      "Our Pumula Branch is actively involved in community outreach, serving the local community through various programs and initiatives.",
    history:
      "Established in 2021 to serve the Pumula community, this branch has become a beacon of hope through its extensive outreach and feeding programs.",
    achievements: [
  ...
  kingsdale: {
    ...
    leadership: [
      { role: "Pastor", name: "Pastor Ndere", spouse: "Amai" },
      { role: "Mvangeri", name: "Mvangeri Manjemanje", spouse: "Amai" },
    ...
    description:
      "Strategically located near transport hubs, our Kingsdale Branch reaches travelers and workers with the message of hope.",
    history:
      "Founded in 2022 to serve the transport community, this branch has become a spiritual oasis for travelers and workers in the Kingsdale area.",
    achievements: [
    ...
    upcomingEvents: [
      {
        title: "Transport Workers Fellowship",
        date: "2025-02-11",
        time: "6:00 PM",
      },
      {
        title: "Early Morning Prayer Marathon",
        date: "2025-02-18",
        time: "5:00 AM",
      },
  ...
  gweru: {
    ...
    description:
      "Our Gweru Branch serves as the spiritual hub for the Midlands province, overseeing ministry and outreach in the region.",
    history:
      "Established in 2020 as our first branch outside Bulawayo, Gweru has become the regional center for Midlands province ministry and outreach.",
    achievements: [
  ...
  kadoma: {
    ...
    leadership: [
      { role: "Pastor", name: "Pastor Hwendere", spouse: "Amai" },
      { role: "Mvangeri", name: "Mvangeri Mugwagwa" },
      { role: "Secretary", name: "Secretary Mhofu" },
    ],
    members: 85,
    ...
    description:
      "Serving the Venice community in Kadoma, our branch provides spiritual support and guidance to families and workers.",
    history:
      "Founded in 2022 to serve the Venice community, Venice Branch has become a spiritual home for miners and families in the area.",
    achievements: [
  ...
  harare: {
    ...
    description:
      "Located in the capital city, our Harare Branch provides spiritual leadership and influence with national impact from the heart of Zimbabwe.",
    history:
      "Established in 2023 as our capital city branch, Harare has become a center for national influence and leadership development.",
    achievements: [
    ...
    upcomingEvents: [
      ...
      {
        title: "Government Leaders Prayer",
        date: "2025-03-03",
        time: "6:00 PM",
      },
    ],
          ...
          <div className="w-full max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground text-lg max-w-3xl mx-auto">
                Get to know the spiritual leader who guides our{" "}
                {branchData.name} family
              </p>
            </div>
              ...
              <div className="order-2 md:order-1">
                <div className="bg-card rounded-2xl p-8 border border-border">
                  ...
                  <p className="text-muted-foreground text-lg mb-6 leading-relaxed">
                    {branchData.pastor} is dedicated to serving the{" "}
                    {branchData.name} community with passion and commitment.
                    With years of ministry experience, they bring wisdom,
                    compassion, and spiritual guidance to our growing family.
                  </p>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          Shepherd-hearted, visionary, and approachable
                        </p>
                      </div>
                    </div>
                    <div className="flex items-center gap-3">
          ...
          <section className="py-16 sm:py-20 lg:py-24 bg-muted/10">
            <div className="w-full max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-12">
                ...
                <p className="text-muted-foreground text-lg max-w-3xl mx-auto">
                  Meet the core leadership team serving {branchData.name}.
                </p>
              </div>
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {branchData.leadership.map((member: any) => (
                  <div
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <a
                          href={`tel:${branchData.contact.phone}`}
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <a
                          href={`mailto:${branchData.contact.email}`}
                          className="text-sm text-primary hover:underline"
                        >
        ...
        <section className="py-16 sm:py-20 bg-muted/30">
          <div className="w-full max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-muted-foreground text-lg mb-8 max-w-2xl mx-auto">
              Experience the warmth and fellowship of our {branchData.name}{" "}
