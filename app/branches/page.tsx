...
export const metadata: Metadata = {
  ...
  description: "Find a Redemption Apostolic Church branch near you. We have 10 branches across Zimbabwe serving over 1,200 members.",
  alternates: {
    canonical: "/branches",
  },
};
          ...
          <div className="w-full max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 relative">
            <div className="text-center text-primary-foreground">
              ...
              <p className="text-xl text-primary-foreground/80 max-w-3xl mx-auto">
                Find a Redemption Apostolic Church branch near you. We have 10 strategically located branches across Zimbabwe.
              </p>
            </div>
          </div>
        </section>
        <BranchesSection query={searchParams?.q} />
      </main>
      <Footer />
    </>
  );
